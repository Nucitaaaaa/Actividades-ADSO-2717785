...
class FormActualizarEstudiante(forms.Form):
    nombre = forms.CharField(
        label="Nombre",
        max_length=30,
        required=True,
...
class FormActualizarProfesor(forms.Form):
    nombre = forms.CharField(
        label="Nombre",
        max_length=30,
        required=True,
...
class FormActualizarCarrera(forms.Form):
    nombre = forms.CharField(
        label="Nombre",
        max_length=50,
        required=True,
...
class FormActualizarMateria(forms.Form):
    nombre = forms.CharField(
        label="Nombre",
        max_length=50,
        required=True,
